...
from utils.pickle import pickle_save, pickle_load
...
class Experience:
    def __init__(
        ...
        assert self.solver_list, "There should be at least one solver selected."
    ...
    def _get_solver_list(self):
        """
        Build the list of solvers used in the benchmark.
        """
    ...
    def _model_specific_solver_specific_experience(
        ...
        """
        For the given model and solver, returns :
        ...
        for _ in range(self.n_exp):
            ...
            precision_experience.append(norminf(difference))

        return (
            np.mean(runtimes_experience),
    ...
    def print_model_solver_list(self):
        """
        Show the available solvers and models.
        """
